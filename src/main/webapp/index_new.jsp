...
<section id="container">
    ...
    <header class="header dark-bg">
        ...
        <!--logo start-->
        <a href="index_new.jsp" class="logo">Nice <span class="lite">Admin</span></a>
        <!--logo end-->
                ...
                <c:if test="${name!=null}">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li>
                                <a href="reset.html"><i class="icon_key_alt"></i> 重置密码</a>
                            </li>
                            <li>
                                <a href="login.html"><i class="icon_key_alt"></i> 退出登陆</a>
                            </li>
                        </ul>
                    </li>
                </c:if>
        ...
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="index_new.jsp">Home</a></li>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="panel-actions">
                                <a href="index_new.jsp#" class="btn-setting"><i class="fa fa-rotate-right"></i></a>
                                <a href="index_new.jsp#" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
                                <a href="index_new.jsp#" class="btn-close"><i class="fa fa-times"></i></a>
                            </div>
                        </div>
